...
import com.l2jprime.gameserver.network.serverpackets.GameGuardQuery;
...
public class nProtect
{
	...
	private nProtect()
	{
		...
		try
		{
			clazz = Class.forName("com.l2jprime.protection.main");
		...
		catch (final ClassNotFoundException e)
		{
			if (Config.DEBUG)
			{
				LOGGER.warn("nProtect System will be not loaded due to ClassNotFoundException of 'com.l2jprime.protection.main' class");
			}
		}
