...
public class PacketsFloodProtector
{
	...
	{
		// filter on opcodes
		if (NetcoreConfig.getInstance().DISABLE_FULL_PACKETS_FLOOD_PROTECTOR || !isOpCodeToBeTested(opcode, opcode2, client instanceof L2LoginClient))
		{
			return true;
		}
