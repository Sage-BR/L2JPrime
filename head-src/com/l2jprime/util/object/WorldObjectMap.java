...
public class WorldObjectMap<T extends L2Object> extends L2ObjectMap<T>
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#size()
	 */
	@Override
	public int size()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#isEmpty()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#clear()
	 */
	@Override
	public void clear()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#put(T)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#remove(T)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#get(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#contains(T)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.util.L2ObjectMap#iterator()
	 */
	@Override
