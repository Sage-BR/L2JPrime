 ...
 */
package com.l2jprime.gameserver.ai.special.manager;

import org.apache.log4j.Logger;

import com.l2jprime.gameserver.ai.special.Antharas;
import com.l2jprime.gameserver.ai.special.Baium;
import com.l2jprime.gameserver.ai.special.Barakiel;
import com.l2jprime.gameserver.ai.special.Core;
import com.l2jprime.gameserver.ai.special.FairyTrees;
import com.l2jprime.gameserver.ai.special.Frintezza;
import com.l2jprime.gameserver.ai.special.Golkonda;
import com.l2jprime.gameserver.ai.special.Gordon;
import com.l2jprime.gameserver.ai.special.Hallate;
import com.l2jprime.gameserver.ai.special.IceFairySirra;
import com.l2jprime.gameserver.ai.special.Kernon;
import com.l2jprime.gameserver.ai.special.Monastery;
import com.l2jprime.gameserver.ai.special.Orfen;
import com.l2jprime.gameserver.ai.special.QueenAnt;
import com.l2jprime.gameserver.ai.special.SummonMinions;
import com.l2jprime.gameserver.ai.special.Transform;
import com.l2jprime.gameserver.ai.special.Valakas;
import com.l2jprime.gameserver.ai.special.VanHalter;
import com.l2jprime.gameserver.ai.special.VarkaKetraAlly;
import com.l2jprime.gameserver.ai.special.Zaken;
import com.l2jprime.gameserver.ai.special.ZombieGatekeepers;
