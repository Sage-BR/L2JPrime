...
import com.l2jprime.gameserver.model.actor.instance.L2CommanderInstance;
...
public class L2FortSiegeGuardAI extends L2CharacterAI implements Runnable
{
	...
	private final void factionNotifyAndSupport()
	{
		...
		if ((((L2NpcInstance) _actor).getFactionId() == null) || (target == null) || target.isInvul() || (Rnd.get(10) > 4))
		{
	...
	private void attackPrepare()
	{
		...
		if (((attackTarget instanceof L2PcInstance) && sGuard.getFort().getSiege().checkIsDefender(((L2PcInstance) attackTarget).getClan())) || !GeoData.getInstance().canSeeTarget(_actor, attackTarget))
		{
