...
import com.l2jprime.gameserver.model.MobGroup;
...
public class L2ControllableMobAI extends L2AttackableAI
{
	...
	private boolean autoAttackCondition(final L2Character target)
	{
		...
		if (target.isAlikeDead() || !me.isInsideRadius(target, me.getAggroRange(), false, false) || (Math.abs(_actor.getZ() - target.getZ()) > 100) || target.isInvul())
		{
			return false;
		}
