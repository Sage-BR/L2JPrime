...
import com.l2jprime.gameserver.network.serverpackets.AquireSkillInfo;
...
public class RequestAquireSkillInfo extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((trainer == null) || (!activeChar.isGM() && !activeChar.isInsideRadius(trainer, L2NpcInstance.INTERACTION_DISTANCE, false, false)))
		{
			return;
		}
