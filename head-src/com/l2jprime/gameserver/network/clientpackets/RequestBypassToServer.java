...
import com.l2jprime.gameserver.model.actor.instance.L2SymbolMakerInstance;
...
public final class RequestBypassToServer extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if ((activeChar == null) || !getClient().getFloodProtectors().getServerBypass().tryPerformAction(_command))
		{
			return;
		}
