...
import com.l2jprime.gameserver.network.serverpackets.ChairSit;
import com.l2jprime.gameserver.network.serverpackets.RecipeShopManageList;
...
public final class RequestActionUse extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (((_actionId != 0) && activeChar.isAlikeDead()) || activeChar.isOutOfControl())
		{
