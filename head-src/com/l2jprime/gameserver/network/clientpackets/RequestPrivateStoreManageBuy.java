...
import com.l2jprime.gameserver.network.serverpackets.PrivateStoreManageListBuy;
...
public final class RequestPrivateStoreManageBuy extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (player.isAlikeDead() || player.isInOlympiadMode() || player.isSittingTaskLaunched())
		{
