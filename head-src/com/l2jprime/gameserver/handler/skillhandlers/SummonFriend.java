...
public class SummonFriend implements ISkillHandler
{
	...
	public void useSkill(final L2Character activeChar, final L2Skill skill, final L2Object[] targets)
	{
		...
		{
			((L2PcInstance) activeChar).sendMessage("You do not meet the required condition to summon a friend.");
			return;
		}

		if (((L2Character) activeChar.getTarget()).isInsideZone(L2Character.ZONE_NOSUMMONFRIEND))
		{
			((L2PcInstance) activeChar).sendMessage("Your friend do not meet the required condition to be summoned.");
			return;
		}
		...
		if (activePlayer._inEvent || (activePlayer._inEventCTF && CTF.is_started()))
		{
