...
import com.l2jprime.gameserver.communitybbs.Manager.AdminBBSManager;
...
public class AdminBBS implements IAdminCommandHandler
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.handler.IAdminCommandHandler#useAdminCommand (java.lang.String, com.l2jprime.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.handler.IAdminCommandHandler#getAdminCommandList()
	 */
	@Override
