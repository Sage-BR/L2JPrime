...
import com.l2jprime.gameserver.model.actor.instance.L2TamedBeastInstance;
...
class OlympiadGameTask implements Runnable
{
	...
	private boolean runGame()
	{
		...
		{
			_game._playerOne.sendMessage("Sorry but you cannot battle someone with same Pc as yours.");
			_game._playerTwo.sendMessage("Sorry but you cannot battle someone with same Pc as yours.");
			return _started;
		}
		/** No Duall Box pc fim **/
		...
		if (checkObserverStatusBug(_game._playerOne) || checkObserverStatusBug(_game._playerTwo))
		{
