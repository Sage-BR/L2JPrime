 ...
 */
package com.l2jprime.gameserver.model.entity.event.manager;
...
public class EventManager
{
	...
	private final static String EVENT_MANAGER_CONFIGURATION_FILE = "./config/mods/eventmanager.properties";
