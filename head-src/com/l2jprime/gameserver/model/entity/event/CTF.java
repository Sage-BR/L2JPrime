 ...
 */
package com.l2jprime.gameserver.model.entity.event;
...
import com.l2jprime.gameserver.model.entity.event.manager.EventTask;
...
public class CTF implements EventTask
{
	...
	{
		if ((_player == null) || (_player.isOnline() == 0) || !((_player.getX() > (_eventCenterX - _eventOffset)) && (_player.getX() < (_eventCenterX + _eventOffset)) && (_player.getY() > (_eventCenterY - _eventOffset)) && (_player.getY() < (_eventCenterY + _eventOffset)) && (_player.getZ() > (_eventCenterZ - _eventOffset)) && (_player.getZ() < (_eventCenterZ + _eventOffset))))
		{
			return true;
		}
		return false;
