...
import com.l2jprime.gameserver.model.spawn.AutoSpawn.AutoSpawnInstance;
...
public class SevenSigns
{
	 ...
	 * @return int cabal
	 */
	public int setPlayerInfo(final L2PcInstance player, final int chosenCabal, final int chosenSeal)
	{
