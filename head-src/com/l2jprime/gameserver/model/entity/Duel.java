 ...
 */
package com.l2jprime.gameserver.model.entity;
...
import com.l2jprime.gameserver.network.serverpackets.ExDuelEnd;
import com.l2jprime.gameserver.network.serverpackets.ExDuelReady;
import com.l2jprime.gameserver.network.serverpackets.ExDuelStart;
...
public class Duel
{
	...
	public DuelResultEnum checkEndDuelCondition()
	{
		...
		else if (!_partyDuel)
		{
			...
			if ((_playerA.getDuelState() == DUELSTATE_INTERRUPTED) || (_playerB.getDuelState() == DUELSTATE_INTERRUPTED) || !_playerA.isInsideRadius(_playerB, 1600, false, false) || isDuelistInPvp(true))
			{
				return DuelResultEnum.Canceled;
			}
