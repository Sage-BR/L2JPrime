 ...
 */
package com.l2jprime.gameserver.model.entity.siege.clanhalls;
...
import com.l2jprime.gameserver.model.actor.instance.L2DecoInstance;
...
import com.l2jprime.gameserver.model.entity.siege.ClanHallSiege;
...
import com.l2jprime.gameserver.taskmanager.ExclusiveTask;
...
public class BanditStrongholdSiege extends ClanHallSiege
{
	...
	public void startSiege()
	{
		// if (GameServer._instanceOk)
		{
			...
			if ((_clansInfo.size() == 0) || ((_clansInfo.size() == 1) && (clanhall.getOwnerClan() == null)))
			{
				endSiege(false);
				return;
			}
