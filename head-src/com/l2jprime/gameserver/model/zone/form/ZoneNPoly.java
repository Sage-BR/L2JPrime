...
public class ZoneNPoly extends L2ZoneForm
{
	...
	public boolean intersectsRectangle(final int ax1, final int ax2, final int ay1, final int ay2)
	{
		...
		for (int i = 0; i < _y.length; i++)
		{
			...
			if (lineSegmentsIntersect(tX, tY, uX, uY, ax1, ay1, ax1, ay2) || lineSegmentsIntersect(tX, tY, uX, uY, ax1, ay1, ax2, ay1) || lineSegmentsIntersect(tX, tY, uX, uY, ax2, ay2, ax1, ay2) || lineSegmentsIntersect(tX, tY, uX, uY, ax2, ay2, ax2, ay1))
			{
				return true;
			}
		}
