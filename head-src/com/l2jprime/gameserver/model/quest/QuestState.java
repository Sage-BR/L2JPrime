 ...
 */
package com.l2jprime.gameserver.model.quest;
...
import com.l2jprime.gameserver.network.serverpackets.ExShowQuestMark;
...
import com.l2jprime.gameserver.network.serverpackets.TutorialCloseHtml;
import com.l2jprime.gameserver.network.serverpackets.TutorialEnableClientEvent;
import com.l2jprime.gameserver.network.serverpackets.TutorialShowHtml;
import com.l2jprime.gameserver.network.serverpackets.TutorialShowQuestionMark;
...
public final class QuestState
{
	...
	public boolean dropQuestItems(final int itemId, final int minCount, final int maxCount, final int neededCount, int dropChance, final boolean sound)
	{
		...
		if (((neededCount > 0) && (currentCount >= neededCount)) || (currentCount >= neededCount))
		{
			return true;
		}
