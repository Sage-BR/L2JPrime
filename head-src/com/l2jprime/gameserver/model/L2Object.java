...
import com.l2jprime.gameserver.model.actor.knownlist.ObjectKnownList;
import com.l2jprime.gameserver.model.actor.poly.ObjectPoly;
import com.l2jprime.gameserver.model.actor.position.ObjectPosition;
import com.l2jprime.gameserver.model.extender.BaseExtender;
...
import com.l2jprime.gameserver.network.serverpackets.GetItem;
		...
		if (Config.EXTENDERS.get(this.getClass().getName()) != null)
		{
			for (final String className : Config.EXTENDERS.get(this.getClass().getName()))
			{
				try
				{
					...
					if ((clazz == null) || !BaseExtender.class.isAssignableFrom(clazz) || !(Boolean) clazz.getMethod("canCreateFor", L2Object.class).invoke(null, this))
					{
						continue;
					}
