...
import com.l2jprime.gameserver.skills.l2skills.L2SkillCharge;
import com.l2jprime.gameserver.skills.l2skills.L2SkillChargeDmg;
import com.l2jprime.gameserver.skills.l2skills.L2SkillChargeEffect;
import com.l2jprime.gameserver.skills.l2skills.L2SkillCreateItem;
import com.l2jprime.gameserver.skills.l2skills.L2SkillDefault;
import com.l2jprime.gameserver.skills.l2skills.L2SkillDrain;
import com.l2jprime.gameserver.skills.l2skills.L2SkillSeed;
import com.l2jprime.gameserver.skills.l2skills.L2SkillSignet;
import com.l2jprime.gameserver.skills.l2skills.L2SkillSignetCasttime;
...
/**
 * This class...
 * @authors ProGramMoS, eX1steam, l2jprime dev
...
public abstract class L2Skill
{
	...
	public final L2Object[] getTargetList(final L2Character activeChar, final boolean onlyFirst, L2Character target)
	{
		...
		switch (targetType)
		{
			...
			case TARGET_AURA:
			{
				...
				for (final L2Object obj : activeChar.getKnownList().getKnownCharactersInRadius(radius))
				{
					...
					if ((src != null) && ((obj instanceof L2Attackable) || (obj instanceof L2PlayableInstance)))
					{
						...
						if ((obj == activeChar) || (obj == src) || !GeoData.getInstance().canSeeTarget(activeChar, obj))
						{
							continue;
						}
			...
			case TARGET_AREA:
			{
				...
				{
					if ((obj == null) || (!(activeChar instanceof L2PlayableInstance) && !(obj instanceof L2PlayableInstance)) || !((obj instanceof L2Attackable) || (obj instanceof L2PlayableInstance)))
					{
						continue;
					}
					if (obj == cha)
			...
			case TARGET_MULTIFACE:
			{
				...
				for (final L2Object obj : activeChar.getKnownList().getKnownObjects().values())
				{
					if ((obj == null) || !Util.checkIfInRange(radius, activeChar, obj, true))
					{
						continue;
					}
				...
				if (activeChar instanceof L2PcInstance)
				{
					...
					if (clan != null)
					{
						...
						for (final L2Object newTarget : activeChar.getKnownList().getKnownObjects().values())
						{
							...
							// Don't add this target if this is a Pc->Pc pvp casting and pvp condition not met
							if (!Util.checkIfInRange(radius, activeChar, newTarget, true) || !player.checkPvpSkill(newTarget, this))
							{
								continue;
							}
			...
			case TARGET_AREA_CORPSE_MOB:
			{
				...
				if (activeChar.getKnownList() != null)
				{
					for (final L2Object obj : activeChar.getKnownList().getKnownObjects().values())
					{
						if ((obj == null) || !((obj instanceof L2Attackable) || (obj instanceof L2PlayableInstance)) || ((L2Character) obj).isDead() || ((L2Character) obj == activeChar))
						{
							continue;
						}
			...
			case TARGET_AREA_UNDEAD:
			{
				...
				if ((cha != null) && (cha.getKnownList() != null))
				{
					for (final L2Object obj : cha.getKnownList().getKnownObjects().values())
					{
						...
						{
							if (!target.isUndead() || !Util.checkIfInRange(radius, cha, obj, true))
							{
								continue;
							}
			...
			case TARGET_CLAN_MEMBER:
			{
				if (activeChar instanceof L2NpcInstance)
				{
					...
					for (final L2Object newTarget : objs)
					{
						if ((newTarget instanceof L2NpcInstance) && npc.getFactionId().equals(((L2NpcInstance) newTarget).getFactionId()))
						{
							if (!Util.checkIfInRange(getCastRange(), activeChar, newTarget, true) || (((L2NpcInstance) newTarget).getFirstEffect(this) != null))
							{
								continue;
							}
							targetList.add((L2NpcInstance) newTarget);
	...
	{
		if ((!(player instanceof L2PcInstance) && !(player instanceof L2Attackable) && !(player instanceof L2Summon)) || (_funcTemplates == null))
		{
	...
	{
		if (isPassive() || (_effectTemplates == null) || ((effector != effected) && effected.isInvul()))
		{
	...
	{
		if (isPassive() || (_effectTemplatesSelf == null))
		{
			return _emptyEffectSet;
		}
