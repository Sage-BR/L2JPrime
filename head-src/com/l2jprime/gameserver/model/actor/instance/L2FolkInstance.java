...
import com.l2jprime.gameserver.model.L2EnchantSkillLearn;
...
import com.l2jprime.gameserver.network.serverpackets.ExEnchantSkillList;
...
public class L2FolkInstance extends L2NpcInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2NpcInstance#onAction(com.l2jprime.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
				...
				else
				{
					...
					if (_classesToTeach.length != 0)
					{
						...
						while ((count == 0) && (classCheck != null))
						{
							for (final ClassId cid : _classesToTeach)
							{
								if ((cid.level() != classCheck.level()) || (SkillTreeTable.getInstance().getAvailableSkills(player, cid).length == 0))
								{
									continue;
								}
