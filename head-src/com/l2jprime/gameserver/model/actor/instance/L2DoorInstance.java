...
import com.l2jprime.gameserver.ai.L2DoorAI;
...
import com.l2jprime.gameserver.model.L2Territory;
import com.l2jprime.gameserver.model.actor.knownlist.DoorKnownList;
import com.l2jprime.gameserver.model.actor.position.L2CharPosition;
import com.l2jprime.gameserver.model.actor.stat.DoorStat;
import com.l2jprime.gameserver.model.actor.status.DoorStatus;
...
import com.l2jprime.gameserver.network.serverpackets.DoorStatusUpdate;
...
public class L2DoorInstance extends L2Character
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#getActor()
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#moveTo(int, int, int, int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#moveTo(int, int, int)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#stopMove(com.l2jprime.gameserver.model.actor.position.L2CharPosition)
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#hasAI()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#isAutoAttackable(com.l2jprime.gameserver.model.L2Character)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#updateAbnormalEffect()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#getActiveWeaponItem()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#getSecondaryWeaponInstance()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#getSecondaryWeaponItem()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#onAction(com.l2jprime.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#onActionShift(com.l2jprime.gameserver.network.L2GameClient)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#broadcastStatusUpdate()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#doDie(com.l2jprime.gameserver.model.L2Character)
	 */
	@Override
