...
import com.l2jprime.gameserver.model.actor.knownlist.PlayableKnownList;
import com.l2jprime.gameserver.model.actor.stat.PlayableStat;
import com.l2jprime.gameserver.model.actor.status.PlayableStatus;
...
public abstract class L2PlayableInstance extends L2Character
{
	...
	{
		if ((target == null) || (target == this) || !(target instanceof L2PlayableInstance))
		{
