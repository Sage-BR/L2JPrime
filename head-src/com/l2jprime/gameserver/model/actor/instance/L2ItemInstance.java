...
import com.l2jprime.gameserver.model.DropProtection;
...
import com.l2jprime.gameserver.model.actor.knownlist.NullKnownList;
...
import com.l2jprime.gameserver.templates.L2EtcItem;
...
public final class L2ItemInstance extends L2Object
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#onAction(com.l2jprime.gameserver.model.L2PcInstance) also check constraints: only soloing castle owners may pick up mercenary tickets of their castle
	 */
	@Override
	...
	public void updateDatabase()
	{
		...
		{
			if (((_count == 0) && (_loc != ItemLocation.LEASE)) || (_loc == ItemLocation.VOID) || (_ownerId == 0))
			{
				return;
			}
	...
	private void insertIntoDb()
	{
		...
		catch (final MySQLIntegrityConstraintViolationException e)
		{
			...
			if (Config.DEBUG)
			{
				LOGGER.error("ATTENTION: Update Item instead of Insert one, check player with id " + getOwnerId() + " actions on item " + getObjectId());
			}
			updateInDb();
