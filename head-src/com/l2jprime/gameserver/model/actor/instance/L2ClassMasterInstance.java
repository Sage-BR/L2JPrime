...
public final class L2ClassMasterInstance extends L2FolkInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2FolkInstance#onAction(com.l2jprime.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	public void onBypassFeedback(final L2PcInstance player, final String command)
	{
		...
		else if (command.startsWith("change_class"))
		{
			...
			if ((newJobLevel != (jobLevel + 1)) || ((level < 20) && (newJobLevel > 1)))
			{
				return;
			}
