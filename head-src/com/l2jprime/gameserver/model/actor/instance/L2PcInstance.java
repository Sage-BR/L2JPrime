...
import static com.l2jprime.gameserver.ai.CtrlIntention.AI_INTENTION_MOVE_TO;
...
import com.l2jprime.crypt.nProtect;
import com.l2jprime.gameserver.ai.CtrlIntention;
import com.l2jprime.gameserver.ai.L2CharacterAI;
import com.l2jprime.gameserver.ai.L2PlayerAI;
import com.l2jprime.gameserver.cache.HtmCache;
import com.l2jprime.gameserver.cache.WarehouseCacheManager;
import com.l2jprime.gameserver.communitybbs.BB.Forum;
import com.l2jprime.gameserver.communitybbs.Manager.ForumsBBSManager;
import com.l2jprime.gameserver.controllers.GameTimeController;
import com.l2jprime.gameserver.controllers.RecipeController;
import com.l2jprime.gameserver.datatables.AccessLevel;
import com.l2jprime.gameserver.datatables.GmListTable;
import com.l2jprime.gameserver.datatables.HeroSkillTable;
import com.l2jprime.gameserver.datatables.NobleSkillTable;
import com.l2jprime.gameserver.datatables.SkillTable;
import com.l2jprime.gameserver.datatables.csv.FishTable;
...
import com.l2jprime.gameserver.datatables.sql.AccessLevels;
import com.l2jprime.gameserver.datatables.sql.AdminCommandAccessRights;
import com.l2jprime.gameserver.datatables.sql.CharTemplateTable;
...
import com.l2jprime.gameserver.datatables.sql.SkillTreeTable;
import com.l2jprime.gameserver.datatables.xml.ExperienceData;
import com.l2jprime.gameserver.geo.GeoData;
import com.l2jprime.gameserver.handler.IItemHandler;
import com.l2jprime.gameserver.handler.ItemHandler;
import com.l2jprime.gameserver.handler.admincommandhandlers.AdminEditChar;
import com.l2jprime.gameserver.handler.skillhandlers.SiegeFlag;
import com.l2jprime.gameserver.handler.skillhandlers.StrSiegeAssault;
import com.l2jprime.gameserver.handler.skillhandlers.TakeCastle;
import com.l2jprime.gameserver.managers.CastleManager;
import com.l2jprime.gameserver.managers.CoupleManager;
import com.l2jprime.gameserver.managers.CursedWeaponsManager;
import com.l2jprime.gameserver.managers.DimensionalRiftManager;
import com.l2jprime.gameserver.managers.DuelManager;
import com.l2jprime.gameserver.managers.FortSiegeManager;
import com.l2jprime.gameserver.managers.ItemsOnGroundManager;
import com.l2jprime.gameserver.managers.QuestManager;
import com.l2jprime.gameserver.managers.SiegeManager;
import com.l2jprime.gameserver.managers.TownManager;
import com.l2jprime.gameserver.model.BlockList;
import com.l2jprime.gameserver.model.FishData;
import com.l2jprime.gameserver.model.Inventory;
import com.l2jprime.gameserver.model.ItemContainer;
...
import com.l2jprime.gameserver.model.L2Fishing;
...
import com.l2jprime.gameserver.model.L2Radar;
import com.l2jprime.gameserver.model.L2RecipeList;
import com.l2jprime.gameserver.model.L2Request;
import com.l2jprime.gameserver.model.L2ShortCut;
import com.l2jprime.gameserver.model.L2Skill;
import com.l2jprime.gameserver.model.L2Skill.SkillTargetType;
import com.l2jprime.gameserver.model.L2Skill.SkillType;
import com.l2jprime.gameserver.model.L2SkillLearn;
...
import com.l2jprime.gameserver.model.MacroList;
import com.l2jprime.gameserver.model.PartyMatchRoom;
import com.l2jprime.gameserver.model.PartyMatchRoomList;
import com.l2jprime.gameserver.model.PartyMatchWaitingList;
import com.l2jprime.gameserver.model.PcFreight;
import com.l2jprime.gameserver.model.PcInventory;
import com.l2jprime.gameserver.model.PcWarehouse;
import com.l2jprime.gameserver.model.PetInventory;
import com.l2jprime.gameserver.model.PlayerStatus;
import com.l2jprime.gameserver.model.ShortCuts;
import com.l2jprime.gameserver.model.TradeList;
import com.l2jprime.gameserver.model.actor.appearance.PcAppearance;
import com.l2jprime.gameserver.model.actor.knownlist.PcKnownList;
import com.l2jprime.gameserver.model.actor.position.L2CharPosition;
import com.l2jprime.gameserver.model.actor.stat.PcStat;
import com.l2jprime.gameserver.model.actor.status.PcStatus;
import com.l2jprime.gameserver.model.base.ClassId;
import com.l2jprime.gameserver.model.base.ClassLevel;
import com.l2jprime.gameserver.model.base.PlayerClass;
import com.l2jprime.gameserver.model.base.Race;
import com.l2jprime.gameserver.model.base.SubClass;
import com.l2jprime.gameserver.model.entity.Announcements;
import com.l2jprime.gameserver.model.entity.Duel;
import com.l2jprime.gameserver.model.entity.event.CTF;
import com.l2jprime.gameserver.model.entity.event.DM;
import com.l2jprime.gameserver.model.entity.event.L2Event;
import com.l2jprime.gameserver.model.entity.event.TvT;
import com.l2jprime.gameserver.model.entity.event.VIP;
...
import com.l2jprime.gameserver.model.entity.siege.FortSiege;
import com.l2jprime.gameserver.model.entity.siege.Siege;
import com.l2jprime.gameserver.model.entity.siege.clanhalls.DevastatedCastle;
import com.l2jprime.gameserver.model.extender.BaseExtender.EventType;
import com.l2jprime.gameserver.model.quest.Quest;
import com.l2jprime.gameserver.model.quest.QuestState;
import com.l2jprime.gameserver.model.zone.type.L2TownZone;
import com.l2jprime.gameserver.network.L2GameClient;
import com.l2jprime.gameserver.network.SystemMessageId;
import com.l2jprime.gameserver.network.serverpackets.ActionFailed;
import com.l2jprime.gameserver.network.serverpackets.ChangeWaitType;
import com.l2jprime.gameserver.network.serverpackets.CharInfo;
import com.l2jprime.gameserver.network.serverpackets.ConfirmDlg;
...
import com.l2jprime.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.l2jprime.gameserver.network.serverpackets.ExFishingEnd;
import com.l2jprime.gameserver.network.serverpackets.ExFishingStart;
import com.l2jprime.gameserver.network.serverpackets.ExOlympiadMode;
import com.l2jprime.gameserver.network.serverpackets.ExOlympiadUserInfo;
import com.l2jprime.gameserver.network.serverpackets.ExPCCafePointInfo;
import com.l2jprime.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.l2jprime.gameserver.network.serverpackets.FriendList;
import com.l2jprime.gameserver.network.serverpackets.HennaInfo;
...
import com.l2jprime.gameserver.network.serverpackets.LeaveWorld;
import com.l2jprime.gameserver.network.serverpackets.MagicSkillCanceld;
...
import com.l2jprime.gameserver.network.serverpackets.NpcInfo;
import com.l2jprime.gameserver.network.serverpackets.ObservationMode;
import com.l2jprime.gameserver.network.serverpackets.ObservationReturn;
import com.l2jprime.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.l2jprime.gameserver.network.serverpackets.PetInventoryUpdate;
import com.l2jprime.gameserver.network.serverpackets.PlaySound;
import com.l2jprime.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.l2jprime.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.l2jprime.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.l2jprime.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.l2jprime.gameserver.network.serverpackets.PrivateStoreListSell;
import com.l2jprime.gameserver.network.serverpackets.QuestList;
import com.l2jprime.gameserver.network.serverpackets.RecipeShopSellList;
import com.l2jprime.gameserver.network.serverpackets.RelationChanged;
import com.l2jprime.gameserver.network.serverpackets.Ride;
import com.l2jprime.gameserver.network.serverpackets.SendTradeDone;
import com.l2jprime.gameserver.network.serverpackets.SetupGauge;
import com.l2jprime.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.l2jprime.gameserver.network.serverpackets.ShortCutInit;
import com.l2jprime.gameserver.network.serverpackets.SkillCoolTime;
import com.l2jprime.gameserver.network.serverpackets.SkillList;
import com.l2jprime.gameserver.network.serverpackets.Snoop;
...
import com.l2jprime.gameserver.network.serverpackets.TargetSelected;
import com.l2jprime.gameserver.network.serverpackets.TitleUpdate;
import com.l2jprime.gameserver.network.serverpackets.TradePressOtherOk;
import com.l2jprime.gameserver.network.serverpackets.TradePressOwnOk;
import com.l2jprime.gameserver.network.serverpackets.TradeStart;
import com.l2jprime.gameserver.network.serverpackets.TutorialShowHtml;
...
import com.l2jprime.gameserver.skills.BaseStats;
...
import com.l2jprime.gameserver.skills.l2skills.L2SkillSummon;
import com.l2jprime.gameserver.templates.L2Armor;
import com.l2jprime.gameserver.templates.L2ArmorType;
import com.l2jprime.gameserver.templates.L2EtcItemType;
...
import com.l2jprime.gameserver.templates.L2WeaponType;
import com.l2jprime.gameserver.thread.LoginServerThread;
import com.l2jprime.gameserver.thread.ThreadPoolManager;
import com.l2jprime.gameserver.thread.daemons.ItemsAutoDestroy;
import com.l2jprime.gameserver.util.Broadcast;
import com.l2jprime.gameserver.util.FloodProtectors;
...
public final class L2PcInstance extends L2PlayableInstance
{
	...
	// "SELECT account_name, obj_Id, char_name, level, maxHp, curHp, maxCp, curCp, maxMp, curMp, acc, crit, evasion, mAtk, mDef, mSpd, pAtk, pDef, pSpd, runSpd, walkSpd, str, con, dex, _int, men, wit, face, hairStyle, hairColor, sex, heading, x, y, z, movement_multiplier, attack_speed_multiplier,
	// colRad, colHeight, exp, expBeforeDeath, sp, karma, pvpkills, pkkills, clanid, maxload, race, classid, deletetime, cancraft, title, rec_have, rec_left, accesslevel, online, char_slot, lastAccess, clan_privs, wantspeace, base_class, onlinetime, isin7sdungeon, in_jail, jail_timer, newbie,
	// nobless, power_grade, subpledge, last_recom_date, lvl_joined_academy, apprentice, sponsor, varka_ketra_ally,clan_join_expiry_time,clan_create_expiry_time,death_penalty_level,pc_point,banchat_time,name_color,title_color,first_log,aio,aio_end FROM characters WHERE obj_id=?";
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#doAttack(com.l2jprime.gameserver.model.L2Character)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.l2jprime.gameserver.model.L2Character.AIAccessor#doCast(com.l2jprime.gameserver.model.L2Skill)
		 */
		@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2PlayableInstance#getKnownList()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2PlayableInstance#getStat()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2PlayableInstance#getStatus()
	 */
	@Override
	...
	public Quest[] getAllActiveQuests()
	{
		...
		for (final QuestState qs : _quests.values())
		{
			if (qs != null)
			{
				if ((qs.getQuest().getQuestIntId() >= 1999) || (qs.isCompleted() && !Config.DEVELOPER))
				{
					continue;
				}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#updatePvPFlag(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#revalidateZone(boolean)
	 */
	@Override
	...
	public void startMovingTask()
	{
		synchronized (_movingTaskDefined)
		{
			if (!_movingTaskDefined || (isMoving() && isAttackingNow()))
			{
				return;
			}
	...
	public void sitDown()
	{
		...
		if ((isCastingNow() && !_relax) || sittingTaskLaunched)
		{
			// just return
			return;
		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#onActionShift(com.l2jprime.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2PlayableInstance#isInFunEvent()
	 */
	@Override
	...
	{
		if ((getClanId() == 0) || (getClan() == null) || (getClan().getAllyId() == 0))
		{
			return 0;
		}
	...
	protected void doPickupItem(final L2Object object)
	{
		...
		synchronized (target)
		{
			...
			if (!target.isVisible() || (getPrivateStoreType() != 0))
			{
				// Send a Server->Client packet ActionFailed to this L2PcInstance
				sendPacket(ActionFailed.STATIC_PACKET);
				return;
	...
	{
		if ((target == null) || !(target instanceof L2PlayableInstance))
		{
			return;
		}
	...
	private synchronized void storeRecipeBook()
	{
		...
		if (isSubClassActive() || ((getCommonRecipeBook().length == 0) && (getDwarvenRecipeBook().length == 0)))
		{
			return;
		}
	...
	public boolean isAutoAttackable(final L2Character attacker)
	{
		...
		if (attacker instanceof L2PcInstance)
		{
			...
			if (((getDuelState() == Duel.DUELSTATE_DUELLING) && (getDuelId() == ((L2PcInstance) attacker).getDuelId())) || (isInsideZone(ZONE_PVP) && ((L2PcInstance) attacker).isInsideZone(ZONE_PVP)))
			{
				return true;
			}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#toString()
	 */
	@Override
	...
	class kickBot implements Runnable
	{
		...
		public void run()
		{
			if ((isOnline() == 1) && (getPrivateStoreType() == 0) && !isGM())
			{
				...
				LOGGER.warn("Player " + getName() + " kicked from game, no/wrong answer on ANTI BOT!");
				closeNetConnection();
			}
			else
			{
	...
	public void sendSkillList(final L2PcInstance player)
	{
		...
		if (player != null)
		{
			...
			{
				if ((s == null) || (s.getId() > 9000) || s.bestowed())
				{
					continue;
				}
	...
	public synchronized boolean addSubClass(final int classId, final int classIndex)
	{
		...
		if ((getTotalSubClasses() == Config.ALLOWED_SUBCLASS) || (classIndex == 0) || getSubClasses().containsKey(classIndex))
		{
			return false;
		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#onTeleported()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#updatePosition(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#reduceCurrentHp(double, com.l2jprime.gameserver.model.L2Character)
	 */
	@Override
	...
	{
		if ((targetChar == null) || (summonerChar == null) || (summonSkill == null) || !checkSummonerStatus(summonerChar))
		{
			return;
		}
	...
	public static boolean checkSummonTargetStatus(final L2Object target, final L2PcInstance summonerChar)
	{
		...
		if (targetChar.isAlikeDead() || targetChar.isInStoreMode() || targetChar.isRooted() || targetChar.isInCombat())
		{
			return false;
		}
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Character#reduceCurrentHp(double, com.l2jprime.gameserver.model.L2Character, boolean)
	 */
	@Override
	...
	public boolean validateItemManipulationByItemId(final int itemId, final String action)
	{
		...
		if (CursedWeaponsManager.getInstance().isCursed(itemId) || item.isWear())
		{
			// cannot drop/trade wear-items
			return false;
		}
	...
	public boolean validateItemManipulation(final int objectId, final String action)
	{
		...
		if (CursedWeaponsManager.getInstance().isCursed(item.getItemId()) || item.isWear())
		{
			// cannot drop/trade wear-items
			return false;
		}
	...
	public boolean checkMultiBox()
	{
		...
		if ((getClient() != null) && (getClient().getConnection() != null) && !getClient().getConnection().isClosed() && (getClient().getConnection().getInetAddress() != null))
		{
			...
			for (final L2PcInstance player : allPlayers)
			{
				if (player != null)
				{
					if ((player.isOnline() == 1) && (player.getClient() != null) && (player.getClient().getConnection() != null) && !player.getClient().getConnection().isClosed() && (player.getClient().getConnection().getInetAddress() != null) && !player.getName().equals(getName()))
					{
	...
	{
		if ((_inventory == null) || (_inventory.getAllItemsByItemId(item_id) == null) || (_inventory.getAllItemsByItemId(item_id).length == 0))
		{
			return false;
		}
