...
import static com.l2jprime.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.l2jprime.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.l2jprime.gameserver.ai.L2AttackableAI;
...
import com.l2jprime.gameserver.model.actor.instance.L2GuardInstance;
...
import com.l2jprime.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.l2jprime.gameserver.model.actor.instance.L2PcInstance;
import com.l2jprime.gameserver.model.actor.instance.L2PcInstance.SkillDat;
...
import com.l2jprime.gameserver.model.actor.instance.L2RiftInvaderInstance;
...
import com.l2jprime.gameserver.model.actor.knownlist.CharKnownList;
import com.l2jprime.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
import com.l2jprime.gameserver.model.actor.position.L2CharPosition;
import com.l2jprime.gameserver.model.actor.position.ObjectPosition;
import com.l2jprime.gameserver.model.actor.stat.CharStat;
import com.l2jprime.gameserver.model.actor.status.CharStatus;
...
import com.l2jprime.gameserver.model.zone.type.L2BossZone;
...
import com.l2jprime.gameserver.network.serverpackets.Attack;
import com.l2jprime.gameserver.network.serverpackets.BeginRotation;
import com.l2jprime.gameserver.network.serverpackets.ChangeMoveType;
...
import com.l2jprime.gameserver.network.serverpackets.CharMoveToLocation;
import com.l2jprime.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
import com.l2jprime.gameserver.network.serverpackets.L2GameServerPacket;
import com.l2jprime.gameserver.network.serverpackets.MagicEffectIcons;
import com.l2jprime.gameserver.network.serverpackets.MagicSkillCanceld;
import com.l2jprime.gameserver.network.serverpackets.MagicSkillLaunched;
...
import com.l2jprime.gameserver.network.serverpackets.PartySpelled;
import com.l2jprime.gameserver.network.serverpackets.PetInfo;
import com.l2jprime.gameserver.network.serverpackets.RelationChanged;
import com.l2jprime.gameserver.network.serverpackets.Revive;
...
import com.l2jprime.gameserver.network.serverpackets.TargetUnselected;
import com.l2jprime.gameserver.network.serverpackets.TeleportToLocation;
import com.l2jprime.gameserver.network.serverpackets.ValidateLocation;
import com.l2jprime.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.l2jprime.gameserver.skills.Calculator;
...
import com.l2jprime.gameserver.skills.holders.ISkillsHolder;
import com.l2jprime.gameserver.templates.L2CharTemplate;
...
public abstract class L2Character extends L2Object implements ISkillsHolder
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#onSpawn()
	 */
	@Override
	public void onSpawn()
	{
	...
	protected void doAttack(final L2Character target)
	{
		...
		if (isAlikeDead() || ((this instanceof L2NpcInstance) && target.isAlikeDead()))
		{
	...
	private boolean doAttackHitByPole(final Attack attack, final int sAtk)
	{
		...
		for (final L2Object obj : getKnownList().getKnownObjects().values())
		{
			...
			{
				if (((obj instanceof L2PetInstance) && (this instanceof L2PcInstance) && (((L2PetInstance) obj).getOwner() == (L2PcInstance) this)) || !Util.checkIfInRange(maxRadius, this, obj, false))
				{
					continue;
				}
	...
	public void doCast(final L2Skill skill)
	{
		...
		if ((skill == null) || (skill.isMagic() && isMuted() && !skill.isPotion()))
		{
	...
	protected void useMagic(final L2Skill skill)
	{
		...
		if ((skill == null) || isDead() || (!skill.isPotion() && isAllSkillsDisabled()))
		{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#getKnownList()
	 */
	@Override
	...
	public final boolean isOnGeodataPath()
	{
		...
		try
		{
			if ((move.onGeodataPathIndex == -1) || (move.onGeodataPathIndex == (move.geoPath.length - 1)))
			{
				return false;
			}
		}
	 ...
	 * <BR>
	 * see com.l2jprime.gameserver.model.L2Character
	 */
			...
			if ((((this instanceof L2PcInstance) && Config.ALLOW_PLAYERS_PATHNODE) || !(this instanceof L2PcInstance)) && (Config.GEODATA == 2) && ((originalDistance - distance) > 100) && (distance < 2000) && !isAfraid())
			{
				...
				if ((this instanceof L2PlayableInstance) || isInCombat() || (this instanceof L2MinionInstance))
				{
					...
					if ((m.geoPath == null) || (m.geoPath.length < 2)) // No path found
					{
						...
						if ((Config.ALLOW_PLAYERS_PATHNODE && (this instanceof L2PcInstance)/* this instanceof L2PcInstance || */) || (!(this instanceof L2PlayableInstance) && (Math.abs(z - curZ) > 140)) || ((this instanceof L2Summon) && !((L2Summon) this).getFollowStatus()))
						{
							getAI().setIntention(CtrlIntention.AI_INTENTION_IDLE);
							return;
						}
	...
	public static boolean isInsidePeaceZone(final L2Object attacker, final L2Object target)
	{
		...
		if ((target instanceof L2GuardInstance) || (attacker instanceof L2GuardInstance) || (target instanceof L2NpcInstance) || (attacker instanceof L2NpcInstance))
		{
			return false;
		}
	...
	public void removeChanceSkill(final int id)
	{
		synchronized (this)
		{
			for (final L2Skill skill : _chanceSkills.keySet())
			{
				if (skill.getId() == id)
				{
	...
	public boolean doesStack(final L2Skill checkSkill)
	{
		...
		final String stackType = checkSkill._effectTemplates[0].stackType;
	...
	public void onMagicHitTimer(final L2Object[] targets, final L2Skill skill, final int coolTime, final boolean instant)
	{
		...
		else
		{
			if (skill.isPotion())
			{
				_potionCast = ThreadPoolManager.getInstance().scheduleEffect(new MagicUseTask(targets, skill, coolTime, 3), coolTime);
			}
			else
			{
	 ...
	 */
	public boolean isSkillDisabled(final L2Skill _skill)
	{
							...
							else if (player instanceof L2Attackable)
							{
								switch (skill.getSkillType())
								{
									...
									default:
										...
										/*
										 * ((L2Character) target).getAI().notifyEvent(CtrlEvent.EVT_ATTACKED, this); - Deprecated Notify the AI that is being attacked. It should be notified once the skill is finished in order to avoid AI action previous to skill end. IE: Backstab on monsters, the AI
										 * rotates previous to skill end so it doesn't make affect. We calculate the hit time to know when the AI should rotate.
										 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.L2Object#toString()
	 */
	@Override
	...
	/*
	 * public L2Character getLastBuffer() { return _lastBuffer; }
	 */
