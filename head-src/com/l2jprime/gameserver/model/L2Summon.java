...
import com.l2jprime.gameserver.ai.L2SummonAI;
...
import com.l2jprime.gameserver.model.actor.knownlist.SummonKnownList;
import com.l2jprime.gameserver.model.actor.stat.SummonStat;
import com.l2jprime.gameserver.model.actor.status.SummonStatus;
...
import com.l2jprime.gameserver.network.serverpackets.PetDelete;
import com.l2jprime.gameserver.network.serverpackets.PetStatusShow;
import com.l2jprime.gameserver.network.serverpackets.PetStatusUpdate;
...
public abstract class L2Summon extends L2PlayableInstance
{
	...
	public void useMagic(L2Skill skill, final boolean forceUse, final boolean dontMove)
	{
		...
		if ((skill == null) || isDead() || skill.isPassive() || isCastingNow())
		{
			return;
		}
	 ...
	 * @see com.l2jprime.gameserver.model.L2Character#doCast(com.l2jprime.gameserver.model.L2Skill)
	 */
	@Override
