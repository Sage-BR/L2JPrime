...
import com.l2jprime.gameserver.skills.conditions.Condition;
import com.l2jprime.gameserver.skills.conditions.ConditionElementSeed;
import com.l2jprime.gameserver.skills.conditions.ConditionForceBuff;
import com.l2jprime.gameserver.skills.conditions.ConditionGameChance;
import com.l2jprime.gameserver.skills.conditions.ConditionGameTime;
import com.l2jprime.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import com.l2jprime.gameserver.skills.conditions.ConditionLogicAnd;
import com.l2jprime.gameserver.skills.conditions.ConditionLogicNot;
import com.l2jprime.gameserver.skills.conditions.ConditionLogicOr;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerClassIdRestriction;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerHp;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerHpPercentage;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerLevel;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerMp;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerRace;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerState;
import com.l2jprime.gameserver.skills.conditions.ConditionPlayerState.CheckPlayerState;
import com.l2jprime.gameserver.skills.conditions.ConditionSkillStats;
import com.l2jprime.gameserver.skills.conditions.ConditionSlotItemId;
import com.l2jprime.gameserver.skills.conditions.ConditionTargetAggro;
import com.l2jprime.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import com.l2jprime.gameserver.skills.conditions.ConditionTargetLevel;
import com.l2jprime.gameserver.skills.conditions.ConditionTargetRaceId;
import com.l2jprime.gameserver.skills.conditions.ConditionTargetUsesWeaponKind;
import com.l2jprime.gameserver.skills.conditions.ConditionUsingItemType;
import com.l2jprime.gameserver.skills.conditions.ConditionUsingSkill;
import com.l2jprime.gameserver.skills.conditions.ConditionWithSkill;
import com.l2jprime.gameserver.skills.effects.EffectTemplate;
import com.l2jprime.gameserver.skills.funcs.FuncTemplate;
import com.l2jprime.gameserver.skills.funcs.Lambda;
import com.l2jprime.gameserver.skills.funcs.LambdaCalc;
import com.l2jprime.gameserver.skills.funcs.LambdaConst;
import com.l2jprime.gameserver.skills.funcs.LambdaStats;
