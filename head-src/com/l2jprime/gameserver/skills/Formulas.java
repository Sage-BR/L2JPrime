...
import com.l2jprime.gameserver.model.L2SiegeClan;
...
import com.l2jprime.gameserver.model.actor.instance.L2CubicInstance;
...
public final class Formulas
{
	...
	{
		if ((attacker == null) || ((target.calcStat(Stats.DEBUFF_IMMUNITY, 0, null, skill) > 0) && skill.is_Debuff()))
		{
			return false;
		}
	...
	{
		if ((attacker == null) || (skill.getLevelDepend() == 0))
		{
			return 0;
		}
	 ...
	 * @return damage points
	 */
	public static final double calcChargeSkillsDam(final L2Character attacker, final L2Character target, final L2Skill skill, final boolean shld, final boolean crit, final boolean ss, final int _numCharges)
	{
		if (attacker instanceof L2PcInstance)
		{
			final L2PcInstance pcInst = (L2PcInstance) attacker;
