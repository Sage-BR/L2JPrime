 ...
 */
package com.l2jprime.gameserver.powerpak.RaidInfo;
...
public class RaidInfoHandler implements ICustomByPassHandler
{
	...
	public void handleCommand(final String command, final L2PcInstance player, final String parameters)
	{
		...
		if ((player == null) || !(player.getTarget() instanceof L2NpcInstance) || (((L2NpcInstance) player.getTarget()).getNpcId() != NPC_ID))
		{
			return;
		}
