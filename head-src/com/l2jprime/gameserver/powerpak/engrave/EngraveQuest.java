package com.l2jprime.gameserver.powerpak.engrave;
...
import com.l2jprime.gameserver.model.quest.State;
	...
	public String onAdvEvent(final String event, final L2NpcInstance npc, final L2PcInstance player)
	{
		...
		if (event.startsWith("mark") || event.startsWith("clear"))
		{
			...
			if (it != null)
			{
				...
				{
					final L2ItemInstance pit = player.getInventory().getItemByItemId(PowerPakConfig.ENGRAVE_PRICE_ITEM);
		...
		else if (event.startsWith("engrave"))
		{
			...
			if ((PowerPakConfig.ENGRAVE_PRICE > 0) && (PowerPakConfig.ENGRAVE_PRICE_ITEM > 0))
			{
				...
				final L2ItemInstance it = player.getInventory().getItemByItemId(PowerPakConfig.ENGRAVE_PRICE_ITEM);
