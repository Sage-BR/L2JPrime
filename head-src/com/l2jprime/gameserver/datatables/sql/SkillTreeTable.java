...
import com.l2jprime.gameserver.skills.holders.PlayerSkillHolder;
...
public class SkillTreeTable
{
	...
	public int getSkillSpCost(final L2PcInstance player, final L2Skill skill)
	{
		...
		{
			if ((enchantSkillLearn.getId() != skill.getId()) || (enchantSkillLearn.getLevel() != skill.getLevel()) || (76 > player.getLevel()))
			{
				continue;
			}
	...
	public byte getSkillRate(final L2PcInstance player, final L2Skill skill)
	{
		...
		for (final L2EnchantSkillLearn enchantSkillLearn : enchantSkillLearnList)
		{
			if ((enchantSkillLearn.getId() != skill.getId()) || (enchantSkillLearn.getLevel() != skill.getLevel()))
			{
				continue;
			}
