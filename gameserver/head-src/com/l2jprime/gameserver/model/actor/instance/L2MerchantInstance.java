...
import com.l2jprime.gameserver.network.serverpackets.SellList;
import com.l2jprime.gameserver.network.serverpackets.StatusUpdate;
import com.l2jprime.gameserver.network.serverpackets.WearList;
...
public class L2MerchantInstance extends L2FolkInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2NpcInstance#onActionShift(com.l2jprime.gameserver.network.L2GameClient)
	 */
	@Override
