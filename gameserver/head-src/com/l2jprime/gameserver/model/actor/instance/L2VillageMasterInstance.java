...
import com.l2jprime.gameserver.model.L2Clan.SubPledge;
import com.l2jprime.gameserver.model.L2ClanMember;
import com.l2jprime.gameserver.model.L2PledgeSkillLearn;
import com.l2jprime.gameserver.model.base.ClassId;
import com.l2jprime.gameserver.model.base.ClassType;
import com.l2jprime.gameserver.model.base.PlayerClass;
import com.l2jprime.gameserver.model.base.PlayerRace;
...
import com.l2jprime.gameserver.network.serverpackets.AquireSkillList;
...
public final class L2VillageMasterInstance extends L2FolkInstance
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2FolkInstance#onBypassFeedback(com.l2jprime.gameserver.model.actor.instance.L2PcInstance, java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.model.actor.instance.L2NpcInstance#getHtmlPath(int, int)
	 */
	@Override
	 ...
	 */
	public void dissolveClan(final L2PcInstance player, final int clanId)
	{
		if (Config.DEBUG)
		{
	 ...
	 * @param clanId the clan id
	 */
	public void recoverClan(final L2PcInstance player, final int clanId)
	{
		if (Config.DEBUG)
		{
	 ...
	 */
	public void changeClanLeader(final L2PcInstance player, final String target)
	{
		if (Config.DEBUG)
		{
	 ...
	 */
	public void createSubPledge(final L2PcInstance player, final String clanName, final String leaderName, final int pledgeType, final int minClanLvl)
	{
		if (Config.DEBUG)
		{
	 ...
	 * @param leaderName the leader name
	 */
	public void assignSubPledgeLeader(final L2PcInstance player, final String clanName, final String leaderName)
	{
		if (Config.DEBUG)
		{
	 ...
	 */
	private final Set<PlayerClass> getAvailableSubClasses(final L2PcInstance player)
	{
	 ...
	 * @param player the player
	 */
	public void showPledgeSkillList(final L2PcInstance player)
	{
		if (Config.DEBUG)
		{
	 ...
	 * @return the string
	 */
	private final String formatClassForDisplay(final PlayerClass className)
	{
	 ...
	 * @return the iterator
	 */
	private Iterator<SubClass> iterSubClasses(final L2PcInstance player)
	{
