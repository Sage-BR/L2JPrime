 ...
 */
package com.l2jprime.gameserver.model.spawn;
...
public class L2Spawn
{
	...
	public L2Spawn(final L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		_constructor = Class.forName("com.l2jprime.gameserver.model.actor.instance." + implementationName + "Instance").getConstructor(parameters);
