...
public final class ValidatePosition extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		 ...
		 * activeChar.setXYZ(realX, realY, _z); } } //activeChar.setXYZ(realX, realY, _z); } if(Config.DEBUG) { int realHeading = activeChar.getHeading(); LOGGER.fine("client pos: " + _x + " " + _y + " " + _z + " head " + _heading); LOGGER.fine("server pos: " + realX + " " + realY + " " + realZ +
		 * " head " + realHeading); } }
		 */
