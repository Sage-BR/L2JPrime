...
import com.l2jprime.gameserver.network.clientpackets.RequestBypassToServer;
...
public class NpcHtmlMessage extends L2GameServerPacket
{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.network.serverpackets.L2GameServerPacket#runImpl()
	 */
	@Override
	public void runImpl()
	{
	...
	/*
	 * (non-Javadoc)
	 * @see com.l2jprime.gameserver.network.serverpackets.L2GameServerPacket#writeImpl()
	 */
	@Override
