...
values
(53, 20830, 'Angelic Shop', 1, 'L2 Prime', 1, 'Monster.angel', 13.50, 36.50, 72, 'male', 'L2Merchant', 40, 4013, 1565, 53.72, 3.09, 40, 43, 30, 21, 20, 10, 0, 0, 1710, 406, 849, 399, 278, 500, 333, 148, 0, 0, 33, 187, 'tower_guard_clan', 400, 0, 10, 'LAST_HIT'), 
(7077, 31862, 'Vortex Gatekeeper', 1, 'L2 Prime', 1, 'NPC.broadcasting_tower', 7.00, 35.00, 70, 'etc', 'L2Teleporter', 40, 3862, 1493, 11.85, 2.78, 40, 43, 30, 21, 20, 10, 490, 10, 1314, 470, 780, 382, 278, 0, 333, 0, 0, 0, 55, 132, '', 0, 1, 0, 'LAST_HIT'),
(50019, 27214, 'Guardian Buffer', 1, 'L2 Prime', 1, 'Monster2.apostle_warrior', 8.00, 30.00, 76, 'female', 'L2Npc', 40, 4297, 1710, 13.43, 3.09, 40, 43, 30, 21, 20, 10, 0, 0, 2242, 534, 994, 433, 200, 0, 333, 80, 0, 0, 55, 198, 'guard_of_secrets_clan', 300, 0, 0, 'LAST_HIT');
